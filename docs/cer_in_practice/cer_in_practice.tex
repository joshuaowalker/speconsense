...
Drawn from~\cite{hp_paper}~\S 8.6 Table 16 (re-estimation under the current
...
Section~\ref{sec:qctx_pooling}: the effects are smaller than the run-to-run
noise floor and cross-cell counts are too sparse to resolve the finer
segmentation stably.
...
\midrule
\texttt{non-hp-sub}            & 0.0039 & \cite{hp_paper}~\S 8.6 Table 16 (approach 2, ont98) \\
\texttt{non-hp-indel}          & 0.0074 & \cite{hp_paper}~\S 8.6 Table 16 (approach 2, ont98) \\
\midrule
\texttt{hp-l1}                 & 0.0047 & \cite{hp_paper}~\S 8.6 Table 16 (v2\_ef, ont98) \\
\texttt{hp-l2}                 & 0.0062 & \cite{hp_paper}~\S 8.6 Table 16 (v2\_ef, ont98) \\
\texttt{hp-l3}                 & 0.0076 & \cite{hp_paper}~\S 8.6 Table 16 (v2\_ef, ont98) \\
\texttt{hp-l4}                 & 0.0081 & \cite{hp_paper}~\S 8.6 Table 16 (v2\_ef, ont98) \\
\texttt{hp-l5}                 & 0.0087 & \cite{hp_paper}~\S 8.6 Table 16 (v2\_ef, ont98) \\
\midrule
...
run-to-run variation of $\sim\!0.6\times$~\cite{hp_paper}~\S 5.4, the finer
cells would introduce false precision rather than discrimination. Per-base
and per-direction re-estimation under the current pipeline has not been
performed; the shipped pooled values in Table~\ref{tab:default_qctx} are the
authoritative production defaults.
