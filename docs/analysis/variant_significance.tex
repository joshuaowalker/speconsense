...
variant is at least as significant as a single-position variant. The analysis
that follows therefore uses $K = 1$ throughout as the conservative bound.
...
regions or around specific sequence motifs~\cite{delahaye2021}---the homopolymer normalization step
...
distinguishability for lower-quality reads. Table~\ref{tab:min_M} provides direct lookup of the minimum read support needed
